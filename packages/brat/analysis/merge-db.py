"""
Merges brat databases (.gpkg) specified in the script.
You can edit the config with your database paths and desired columns and run this script.
Note that it is designed to only copy relevant integer outputs;
    geometry columns will not be copied correctly.
Disclaimer: This script was partially generated by AI.
