"""
Merges BRAT databases (.gpkg) specified in the config below.
...
Note that it is designed to only copy integer outputs; geometry columns will not be copied correctly.
